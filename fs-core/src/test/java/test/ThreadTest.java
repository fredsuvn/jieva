...
import xyz.srclab.common.base.FsThread;
...
public class ThreadTest {
    ...
    private static final class T3 {
        public static void invoke3() {
            StackTraceElement element1 = FsThread.findStackTraceCaller(T1.class.getName(), "invoke1");
            Assert.assertEquals(element1.getClassName(), ThreadTest.class.getName());
            Assert.assertEquals(element1.getMethodName(), "testFindStackTraceCaller");
            StackTraceElement element2 = FsThread.findStackTraceCaller(T2.class.getName(), "invoke2");
            Assert.assertEquals(element2.getClassName(), T1.class.getName());
            Assert.assertEquals(element2.getMethodName(), "invoke1");
            StackTraceElement element3 = FsThread.findStackTraceCaller(T3.class.getName(), "invoke3");
