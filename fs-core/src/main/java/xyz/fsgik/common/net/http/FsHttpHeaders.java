...
public class FsHttpHeaders {
     ...
     * @see #addHeaders(Map)
     */
    public static FsHttpHeaders from(Map<String, ?> map) {
        FsHttpHeaders headers = new FsHttpHeaders();
        headers.addHeaders(map);
        return headers;
    }
     ...
     */
    public static FsHttpHeaders of(String... keyValues) {
        FsHttpHeaders headers = new FsHttpHeaders();
        headers.addHeaders(FsCollect.linkedHashMap(keyValues));
        return headers;
    }
     ...
     * @return this headers
     */
    public FsHttpHeaders addHeader(String key, String value) {
     ...
     * @return this headers
     */
    public FsHttpHeaders setHeader(String key, String value) {
        List<String> list = headerMap.computeIfAbsent(key, k -> new LinkedList<>());
        list.clear();
        list.add(value);
        return this;
    ...
    public String getHeaderFirst(String key) {
        ...
        return FsCollect.isEmpty(list) ? null : list.get(0);
    }
     ...
     * @return this headers
     */
    public FsHttpHeaders addHeader(String key, Object value) {
        List<String> values = headerMap.computeIfAbsent(key, k -> new LinkedList<>());
        if (value instanceof Collection) {
            Collection<Object> c = Fs.as(value);
     ...
     */
    public FsHttpHeaders addHeaders(Map<String, ?> headers) {
        headers.forEach(this::addHeader);
        return this;
    }
     ...
     * @return this headers
     */
    public FsHttpHeaders removeHeader(String key) {
     ...
     * @return this headers
     */
    public FsHttpHeaders clearHeaders() {
        headerMap.clear();
        return this;
    }
