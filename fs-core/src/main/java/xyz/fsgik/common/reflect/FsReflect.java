...
import xyz.fsgik.annotations.OutParam;
...
public class FsReflect {
    ...
    public static Type replaceType(Type type, Type matcher, Type replacement, boolean deep) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (matched) {
                return FsType.parameterizedType(rawType, ownerType, actualTypeArguments);
            } else {
                return type;
            }
        }
        if (type instanceof WildcardType) {
            ...
            if (matched) {
                return FsType.wildcardType(upperBounds, lowerBounds);
            } else {
                return type;
            }
        }
        if (type instanceof GenericArrayType) {
            ...
            if (matched) {
                return FsType.genericArrayType(componentType);
            } else {
                return type;
            }
        }
