...
//
///**
// * TCP/IP server interface, client endpoint of {@link FsNetEndpoint}.
// * <p>
// * A {@link FsTcpClient} implementation should support following types of handler:
// * <ul>
// *     <li>
// *         one {@link FsNetClientHandler}: to deal with client actions;
// *     </li>
// *     <li>
// *         a list of {@link FsNetClientHandler}: to deal with actions for the connection;
// *     </li>
// * </ul>
// *
// * @author fredsuvn
// */
//public interface FsTcpClient extends FsNetEndpoint {
//
//    /**
...
//        private static final FsNetClientHandler EMPTY_CLIENT_HANDLER = new FsNetClientHandler() {
//        };
//
//        private int port = 0;
//        private @Nullable InetAddress hostAddress;
//        private @Nullable FsNetClientHandler clientHandler;
...
//         * Sets client handler.
//         */
//        public Builder clientHandler(FsNetClientHandler clientHandler) {
...
//            private final FsNetClientHandler clientHandler;
...
//                        try {
//                            Socket socket;
//                            Builder.SocketTcpServer.ChannelImpl channel;
//                            try {
//                                socket = serverSocket.accept();
//                                channel = new Builder.SocketTcpServer.ChannelImpl(socket);
//                            } catch (Throwable e) {
...
//                            continue;
//                        }
//                        for (Builder.SocketTcpServer.ChannelImpl c : channels) {
//                            try {
//                                if (!c.isOpened()) {
//                                    c.closeNow();
//                                    continue;
...
//            }
//
//            private void doChannel(Builder.SocketTcpServer.ChannelImpl channel) {
//                byte[] bytes;
//                try {
