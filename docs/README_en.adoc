...
* *boat-others*: Boat also contains libraries for supporting special or third parties, see link:../boat-others/docs/README_en.adoc[boat-others/].
...
* Core and basic interfaces: Accessor (and GenericAccessor), Serial, SpecParser, CachingProductBuilder
...
[source,java]
----
include::../boat-sample/src/test/java/sample/java/xyz/srclab/common/base/BaseSample.java[]
----

.Kotlin Examples
[source,kotlin]
----
include::../boat-sample/src/test/kotlin/sample/kotlin/xyz/srclab/common/base/BaseSample.kt[]
----
