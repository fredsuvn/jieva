...
Using gradle task `publishToMavenLocal` to install into local maven repository.
Setting `publish` info in link:../build.gradle[] for more publish options and tasks.
