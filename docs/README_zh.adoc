...
* *boat-others*: Boat也有对其他特殊需求或第三方的支持, 参见link:../boat-others/[boat-others/].
...
Exception包提供StatusException和ExceptionStatus, 继承自State (参考 <<usage-core-state>>), 还有一个ShouldNotException.
