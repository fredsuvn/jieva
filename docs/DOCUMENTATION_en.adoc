...
* link:../fs-annotations/[fs-annotation]: Annotations; link:../fs-annotations/docs/DOCUMENTATION_en.adoc[javadoc];
* link:../fs-core/[fs-core]: Core lib; link:../fs-core/docs/DOCUMENTATION_en.adoc[javadoc];
* link:../fs-kotlin/[fs-kotlin]: Kotlin support; link:../fs-kotlin/docs/DOCUMENTATION_en.adoc[javadoc];
