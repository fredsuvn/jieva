...
Lang package provides base and enhancement interfaces, functions and
...
-   Core and helper interfaces: Accessor (and GenericAccessor), Serial,
    SpecParser, CachingProductBuilder, Processing;
