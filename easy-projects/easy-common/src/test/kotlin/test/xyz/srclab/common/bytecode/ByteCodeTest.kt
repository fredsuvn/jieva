...
object ByteCodeTest {
    ...
    fun testByteCodeTypes() {
        ...
        val runnableType = BRefType(Runnable::class.java)
        val callableO = BRefType(Callable::class.java)
        val listO = BRefType(List::class.java)
        val mutableSetType = BRefType(MutableSet::class.java)
        val gType = BRefType(G::class.java)
        val functionType = BRefType(Function::class.java)
        val stringType = BRefType(String::class.java)
        ...
        val numberType = BRefType(Number::class.java)
        typeS.addBounds(numberType, runnableType)
        val mutableListInS = BRefType(MutableList::class.java)
        mutableListInS.addGenericTypes(inS)
        val mutableListOutString = BRefType(MutableList::class.java)
        mutableListOutString.addGenericTypes(outString)
        val mutableListString = BRefType(MutableList::class.java)
        mutableListString.addGenericTypes(stringType)
        val mutableListInArrayS = BRefType(MutableList::class.java)
