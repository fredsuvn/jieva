...
public interface GekLogger {
     ...
     */
    static GekLogger defaultLogger() {
     ...
     */
    static GekLogger ofLevel(Level level) {
    ...
    /**
     * Builder for {@link GekLogger}.
     */
    class Builder {

        private static final GekLogger DEFAULT = new Builder().build();
        ...
        private Formatter formatter = logInfo -> {
            ...
            message
                .append(GekDate.format(Date.from(logInfo.time())))
        ...
        public GekLogger build() {
            return new GekLogger() {
