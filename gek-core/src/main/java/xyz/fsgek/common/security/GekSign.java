 ...
 */
@ThreadSafe
public interface GekSign extends Prepareable {
     ...
     */
    static GekSign getInstance(String algorithm) {
     ...
     * @return new instance of specified algorithm
     */
    static GekSign getInstance(String algorithm, String provider) {
        return new SignImpl(algorithm, () -> {
            try {
     ...
     * @return new instance of specified algorithm
     */
    static GekSign getInstance(String algorithm, Provider provider) {
        return new SignImpl(algorithm, () -> {
            try {
                return Signature.getInstance(algorithm, provider);
            } catch (Exception e) {
