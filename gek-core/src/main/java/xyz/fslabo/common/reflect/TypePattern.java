    ...
    private static boolean matchesWildcardType(WildcardType pattern, Type type) {
     ...
     static boolean isAssignable(Type assigned, Type assignee) {
        ...
        if ((assigned instanceof WildcardType)
            || (assignee instanceof WildcardType)) {
            return false;
        }
        if (assigned instanceof Class<?>) {
            Class<?> c1 = (Class<?>) assigned;
            if (assignee instanceof Class<?>) {
                Class<?> c2 = (Class<?>) assignee;
                return isAssignable2(c1, c2);
            }
            if (assignee instanceof ParameterizedType) {
                ParameterizedType p2 = (ParameterizedType) assignee;
            ...
            if (assignee instanceof TypeVariable<?>) {
                TypeVariable<?> v2 = (TypeVariable<?>) assignee;
                Type[] bounds = v2.getBounds();
                for (Type bound : bounds) {
                    if (isAssignable(assigned, bound)) {
                        return true;
                    }
                }
                return false;
            ...
            if (assignee instanceof GenericArrayType) {
                ...
                GenericArrayType g2 = (GenericArrayType) assignee;
        ...
        if (assigned instanceof ParameterizedType) {
            ParameterizedType p1 = (ParameterizedType) assigned;
            if (assignee instanceof Class<?>) {
                ParameterizedType p2 = getGenericSuperType(assignee, (Class<?>) p1.getRawType());
                if (p2 == null) {
                    return false;
                }
        ...
        if (assigned instanceof TypeVariable<?>) {
            TypeVariable<?> v1 = (TypeVariable<?>) assigned;
            if (assignee instanceof TypeVariable<?>) {
                TypeVariable<?> v2 = (TypeVariable<?>) assignee;
                Type[] bounds = v2.getBounds();
                for (Type bound : bounds) {
        ...
        if (assigned instanceof GenericArrayType) {
            GenericArrayType g1 = (GenericArrayType) assigned;
            if (assignee instanceof Class<?>) {
                Class<?> c2 = (Class<?>) assignee;
                if (!c2.isArray()) {
                    return false;
