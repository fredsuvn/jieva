...
public class ConstructorTest {
    ...
    public void testFind() throws Exception {
        Assert.assertEquals(
            Reflects.getConstructors(ReflectClass.class),
            Arrays.asList(ReflectClass.class.getConstructors())
        );
        Assert.assertEquals(
            Reflects.getDeclaredConstructors(ReflectClass.class),
            Arrays.asList(ReflectClass.class.getDeclaredConstructors())
        );
        Assert.assertEquals(
            Reflects.getDeclaredConstructor(ReflectClass.class, String.class),
            ReflectClass.class.getDeclaredConstructor(String.class)
        );
        Assert.assertEquals(
            Reflects.getDeclaredConstructor(ReflectClass.class, String.class, String.class),
    ...
    public void testInvoke() {
        Constructor<ReflectClass> classConstructor = Reflects.getDeclaredConstructor(
