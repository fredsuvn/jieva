...
//    private StringTemplate charsTemplate;
...
//
//        //CharsTemplate
//        charsTemplate = StringTemplate.resolve(charsTemplateContent, "{", "}");
...
//        StringTemplate template = StringTemplate.resolve(charsTemplateContent, "{", "}");
//        StringWriter writer = new StringWriter();
//        template.processTo(writer, charsTemplateArgs);
//    }
//
//    @Benchmark
...
//        StringWriter writer = new StringWriter();
//        charsTemplate.processTo(writer, charsTemplateArgs);
//    }
//
//    @Benchmark
