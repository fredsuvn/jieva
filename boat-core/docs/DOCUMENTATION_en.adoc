...
* Special character support: `BCtlChars`, `BEscChars`, `BCsiChars`, `BSgrChars`;
...
* `ClassProxyFactory`: Factory to create `ClassProxy`, built-in `Reflection`, `spring-core` and `cglib` implementation;
