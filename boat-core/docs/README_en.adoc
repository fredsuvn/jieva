...
* `FastConverter`: A fast type converter which must specify the target type;
...
* `IterableOps`, `ListOps`, `SetOps`, `MapOps`, `SequenceOps`: Ops interfaces, provide chain operation, mainly for Java;
